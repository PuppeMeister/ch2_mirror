...
class alarmModel extends CI_Model{
	...
	public function getActiveAlarm(){
		...
		$queriesArray["getActiveAlarm"][2]="INSERT INTO alarmRecap.`tempForActiveAlarm_mirror`
											(alarmName, summary, siteid, site, firstOccurrence, duration, zone, manager, `table`)
		...
		$queriesArray["getActiveAlarm"][10] = "INSERT INTO alarmRecap.`tempForActiveAlarm`
											  (alarmName, summary, siteid, site, category, firstOccurrence, duration, zone, spvName, spvPhone, manager, `table`)
											  SELECT alarm.alarmName,
													 alarm.summary,
													 alarm.siteid,
													 alarm.site,
